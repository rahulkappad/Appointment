    ...
    <div className='m-5'>
          <div className='flex flex-wrap gap-3'>
            <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
              <img className='w-14' src={assets.earnings} alt="" />
              <div>
            ...
            <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
              <img onClick={()=>{navigate('/doctor-appointments');scrollTo(0,0)}}  className='w-14' src={assets.patients} alt="" />
              <div>
            ...
            <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
              <img onClick={()=>{navigate('/doctor-appointments');scrollTo(0,0)}}  className='w-14' src={assets.appointments} alt="" />
              <div>
            ...
            <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
              <img onClick={()=>{navigate('/doctor-appointments');scrollTo(0,0)}}  className='w-14' src={assets.cancel_icon} alt="" />
              <div>
